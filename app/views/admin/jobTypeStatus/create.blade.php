@extends('admin.layout')
	@section('body')
		<h3 class="page-title">Add Job Type Status</h3>
			<!-- page layout -->
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="{{URL::route('admin.jobTypeStatus.create')}}">Add Job Type Status</a>
					</li>
				</ul>
			</div>
			<div class="row">
                                        ...
                                        'start_status' => 'Start Status',
                                         ...
                                         @elseif($key === 'channel_id')
                                            <div class="form-group" id="countryname">
                                                 <label class="col-md-3 col-sm-3 col-xs-12 control-label">{{ Form::label($key, $value) }}</label>
                                                  <div class="col-md-6 col-sm-6 col-xs-12">
                                                    {{Form::select($key, $channels->lists('channel_name','id'), null,  array('class' =>'form-control')) }}
                                                 </div>
                                             </div>
                                         @elseif($key === 'start_status')
                                             <div class="form-group" id="countryname">
                                                  <label class="col-md-3 col-sm-3 col-xs-12 control-label">{{ Form::label($key, $value) }}</label>
                                                   <div class="col-md-6 col-sm-6 col-xs-12">
                                                     <input type="checkbox" name="start_status" value="1">
                                                  </div>
                                              </div>
                                         @else
                                            <div class="form-group" id="countryname">
